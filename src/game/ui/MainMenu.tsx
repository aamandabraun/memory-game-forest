    ...
    <div className="absolute inset-0 z-20 flex items-end sm:items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative w-full max-w-sm text-center">
        ...
        <div className="rounded-[2rem] border border-accent/20 bg-background/40 backdrop-blur-md px-6 pt-10 pb-7 shadow-warm">
          <h1 className="font-display text-4xl sm:text-5xl leading-none mb-3 text-shadow-warm">
            mata <span className="text-primary italic">viva</span>
          </h1>
          <p className="text-muted-foreground text-sm italic mb-6">
            os bichos lembram. você consegue?
          </p>

          <Button
            size="lg"
            onClick={onStart}
            className="w-full bg-gradient-warm text-primary-foreground font-display text-lg py-6 rounded-full shadow-warm hover:shadow-glow transition-all"
          >
            entrar na mata
          </Button>

          <p className="mt-5 text-[11px] tracking-widest uppercase text-muted-foreground/70">
            60s · 8 pares · floresta traiçoeira
          </p>
        </div>
      </div>
    </div>
